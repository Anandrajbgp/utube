...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        ServiceHelper.setSelectedServiceId(this, ServiceList.YouTube.getServiceId());
    ...
    private void addDrawerMenuForCurrentService() throws ExtractionException {
        ...
        // Keep the drawer focused on everyday uTube navigation.
        drawerLayoutBinding.navigation.getMenu()
    ...
    private void setupDrawerHeader() {
        ...
        // Give branded names enough room in the drawer header.
        // let the text view grow a little more as well.
        if (getString(R.string.app_name).length() > "uTube".length()) {
    ...
    protected void onResume() {
        ...
        mainBinding.getRoot().closeDrawer(GravityCompat.END, false);
        try {
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        final boolean isSearchScreen = fragment instanceof SearchFragment;
        toolbarLayoutBinding.toolbarBrand.setVisibility(isSearchScreen
    ...
    public boolean onOptionsItemSelected(@NonNull final MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_open_drawer) {
            mainBinding.getRoot().openDrawer(GravityCompat.END);
            return true;
        }
